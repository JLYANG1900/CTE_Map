                ...
                <div style="display:flex; gap:15px;">
                    ...
                    <div style="flex:1;">
                        ...
                        <div class="cte-rpg-stat-row">
                             <div class="cte-rpg-stat-bar-container"><div class="label"><span>Vocal</span> <span>${profile.rpgStats.vocal}</span></div><div class="bar-bg"><div class="bar-fill" style="width:${profile.rpgStats.vocal}%; background:#c5a065;"></div></div></div>
                             <div class="cte-rpg-stat-bar-container"><div class="label"><span>Dance</span> <span>${profile.rpgStats.dance}</span></div><div class="bar-bg"><div class="bar-fill" style="width:${profile.rpgStats.dance}%; background:#c5a065;"></div></div></div>
                        </div>
                        ${warningHtml}
                    </div>
                </div>
...
window.CTEMap.switchView = function(viewName, btn) {
    ...
    try {
        ...
        console.error("[CTE Map] Error rendering view:", e);
    }
};
...
function bindRPGEvents() {
    $('.cte-rpg-nav-btn').off('click').on('click', function() {
